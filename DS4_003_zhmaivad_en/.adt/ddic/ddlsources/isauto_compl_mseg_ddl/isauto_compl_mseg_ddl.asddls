@AbapCatalog.sqlViewAppendName: 'ISAUTOCOMPLMSEGV'
@EndUserText.label: 'Extension for Append ISAUTO_COMPL_MSEG on MSEG'
/*
...
*/
extend view nsdm_e_mseg with ISAUTO_COMPL_MSEG_E {
    compl_mark
}           
