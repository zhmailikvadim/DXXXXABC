...
define root view entity zsd_i_stock_difference_calc
  as select from zsd_i_stock_difference_calc_p1
{
  ...
  key          SalesOrderItem,
               ...
               UnrectrictedDifferenceQty -  ErrorsGoodsReceiptUUQuantity + ErrorsGoodsIssueQuantity
                - ErrorsGrEcom  - ErrorsGiEcom - ErrorsInventoryPostingUnQty - UnrectrictedTimingAdjustment                      as RealUnrectrictedDifferenceQty,
               @Semantics.quantity.unitOfMeasure : 'Meins'
               ...
               - ErrorsInventoryPostingQiQty - InQualityInspTimingAdjustment                                                     as RealInQualityInspDifferenceQty,
               @Semantics.quantity.unitOfMeasure : 'Meins'
               ...
               @Semantics.quantity.unitOfMeasure : 'Meins'
               BlockedDifferenceQty - ErrorsGoodsReceiptBlQuantity
               - ErrorsInventoryPostingBlQty - BlockedTimingAdjustment                                                           as RealBlockedDifferenceQty,
               @Semantics.quantity.unitOfMeasure : 'Meins'
