...
define view entity zsd_c_supdmndrejectedoballdoc
...

{
  ...
  key RequirementType,
      ...
      _ProductCollectionText.text                                  as CollectionText,
      ...
      @EndUserText.label: 'Distrib-chain-spec Material Status Text'
      ...
      SalesDocumentItemText                                        as MaterialDescription,
      ...
      RequestedDate                                                as RequirementCreationDate,
