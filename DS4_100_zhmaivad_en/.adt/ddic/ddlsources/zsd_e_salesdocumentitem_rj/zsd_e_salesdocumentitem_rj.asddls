...
extend view I_SalesDocumentItem with ZSD_E_SALESDOCUMENTITEM_RJ
  association to zpd_t_season    as _ArticleSeason     on  $projection.Material            = _ArticleSeason.matnr
                                                       and $projection.SalesOrganization   = _ArticleSeason.vkorg
                                                       and $projection.DistributionChannel = _ArticleSeason.vtweg
                                                       and $projection.ProductSeason       = _ArticleSeason.fsh_season
                                                       and $projection.ProductSeasonYear   = _ArticleSeason.fsh_season_year
