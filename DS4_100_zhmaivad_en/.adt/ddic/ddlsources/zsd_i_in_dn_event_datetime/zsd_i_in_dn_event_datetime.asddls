  ...
  as select from zsd_i_in_dn_event_time_seg
{
  key InboundDeliveryNumber,
      ...
      cast(actual_v_dept_zonfr as zsd_act_vess_depart_start_tz preserving type )                                                                             as actual_v_arr_zonfr,
      ...
      cast(tstmp_to_dats(actual_cnt_dep_eventstfr, actual_cnt_dep_zonfr, $session.client, 'INITIAL')    as zsd_act_cont_arriv_start_date preserving type )   as actual_cnt_dep_eventstfr_date,
      cast(tstmp_to_tims( actual_cnt_dep_eventstfr,actual_cnt_dep_zonfr, $session.client, 'INITIAL')    as zsd_act_cont_arriv_start_time preserving type )   as actual_cnt_dep_eventstfr_time,
      cast(actual_cnt_dep_zonfr as zsd_act_cont_arriv_start_tz preserving type )                                                                             as actual_cnt_dep_zonfr,
