...
define view entity zsd_i_supdmndalldocsditm1
  as select from    zsd_i_supdmndalldocsditmbsc1 as Item
  ...
  association [0..1] to I_SalesDocument as header on Item.RequirementDocumentNumber = header.SalesDocument
{
  ...
  Item.LastChangeDate,
  Item.SalesOffice,
  Item.SalesDocumentRjcnReasonName,
