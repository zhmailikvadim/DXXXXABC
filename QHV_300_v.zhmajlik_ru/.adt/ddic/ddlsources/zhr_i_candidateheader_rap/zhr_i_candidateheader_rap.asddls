...
define root view entity ZHR_I_CANDIDATEHEADER_RAP
 ...
 // composition [0..*] of ZHR_I_DESIRED_PROFESSION_RAP  as _CandidateDesiredProf
  ...
  composition [0..*] of ZHR_I_RECRUITMENT_LOG_RAP    as _CandidateLog
  ...
  association [0..1] to ZHR_I_FAMILY_STAT_VH_RAP      as _FamilyStatVHR     on $projection.family_stat_id = _FamilyStatVHR.id
  //association [0..1] to ZHR_I_EDUC_TYPE_VH_RAP        as _EducTypeVH     on $projection.family_stat_id = _FamilyStatVH.id
