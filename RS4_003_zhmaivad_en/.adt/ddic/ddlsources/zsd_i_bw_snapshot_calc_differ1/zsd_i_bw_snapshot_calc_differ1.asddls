...
define view entity ZSD_I_BW_SNAPSHOT_CALC_DIFFER1
                                                                              ...
                                                                              and $projection.Article         = _ErrorsOmniShipmentSum.Product
{
  ...
  key SalesOrderItem,
      ...
      UnrectrictedWmsStockQuantity - UnrectrictedSapStockQuantity                                                       as BwUnrectrictedDifferenceQty,
      @Semantics.quantity.unitOfMeasure : 'Meins'
      InQualityInspWmsStockQuantity - InQualityInspSapStockQuantity                                                     as BwInQualityInspDifferenceQty,
      @Semantics.quantity.unitOfMeasure : 'Meins'
      BlockedWmsStockQuantity - BlockedSapStockQuantity                                                                 as BwBlockedDifferenceQty,
      @Semantics.quantity.unitOfMeasure : 'Meins'
      UnrectrictedWmsStockQuantity - UnrectrictedSapStockQuantity - UnrectrictedTimingAdjustment                        as UnrectrictedDifferenceQty,
      @Semantics.quantity.unitOfMeasure : 'Meins'
      InQualityInspWmsStockQuantity - InQualityInspSapStockQuantity - InQualityInspTimingAdjustment                     as InQualityInspDifferenceQty,
      @Semantics.quantity.unitOfMeasure : 'Meins'
      BlockedWmsStockQuantity - BlockedSapStockQuantity - BlockedTimingAdjustment                                       as BlockedDifferenceQty,
      @Semantics.quantity.unitOfMeasure : 'Meins'
      $projection.UnrectrictedDifferenceQty + $projection.InQualityInspDifferenceQty + $projection.BlockedDifferenceQty as DifferenceQty,
      @Semantics.quantity.unitOfMeasure : 'Meins'
