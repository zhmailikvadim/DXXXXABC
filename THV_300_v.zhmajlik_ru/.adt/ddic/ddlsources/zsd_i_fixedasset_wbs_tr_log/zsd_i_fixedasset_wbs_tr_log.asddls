@AbapCatalog.sqlViewName: 'ZSDIFIXWBSTRlg'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'WBS Transfer'
@Metadata.ignorePropagatedAnnotations: true
define view ZSD_I_FIXEDASSET_WBS_TR_log
  ...
  association to ZFI_I_WBS_TRANSFER_LOG as _TransferLog on $projection.InvestmentProjectWBSElement = _TransferLog.WbselementParent
{
  ...
  where   ( AssetClass = '97200010'  and AssetDeactivationDate <= '00000000' ) or _TransferLog.AssetParent > ''
